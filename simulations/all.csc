...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype482</identifier>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype815</identifier>
      <description>LUMINOSITY SENSOR</description>
    ...
    <mote>
      ...
      <motetype_identifier>mtype482</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>42.94981972394176</x>
        <y>-116.57889281565635</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
      ...
      <motetype_identifier>mtype815</motetype_identifier>
    </mote>
  </simulation>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.0115809807515186 0.0 0.0 2.0115809807515186 125.85023944378605 248.86061081777143</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
